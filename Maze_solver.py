...
def visualize_maze(maze, path=None, visited=None, pheromones=None):
    if maze is None or not isinstance(maze, np.ndarray):
        raise ValueError("Invalid maze data. Expected a NumPy array.")
